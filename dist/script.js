...
const redirectLegacyServicesLink = () => {
  const isLegacyServicesHash = window.location.hash === '#servicios';
  const isServicesPage = window.location.pathname.endsWith('/servicios.html');
  if (isLegacyServicesHash && !isServicesPage) {
