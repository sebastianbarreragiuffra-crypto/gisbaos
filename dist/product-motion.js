/* Producto: tabs Agencia/Cliente + narrativa de GISBA Pulse + entrada de Próximo paso (una sola vez). */
(function () {
  ...
  /* ----- Pulse y Próximo paso: se reproducen una vez al entrar ----- */
  ...
  var next = document.getElementById('proximo-paso');
  playOnce(next, next && next.querySelector('.pr-next-grid'), 0.25);
})();
